    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse w-100" id="navbarSupportedContent">
            <form class="form-inline my-2 my-lg-0 w-100" id='buscador' >
                <input class="form-control mr-sm-2 w-75" type="search" placeholder="Search" aria-label="Search" id='inputBusqueda' name='inputBusqueda'/>
...
<div class="container">
    <div class="row row-cols-1 row-cols-md-4" id="cardProducto">
...
const busqueda = async(termino)=>{
    const productos = await obtenerDatos(`busqueda/${termino}`);
    productos.forEach(mostrarProducto);
}
